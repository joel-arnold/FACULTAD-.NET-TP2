...
namespace UI.Escritorio {
    ...
    public partial class tp2_netDataSet1 : global::System.Data.DataSet {
        ...
        public partial class materiasDataTable : global::System.Data.TypedTableBase<materiasRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public materiasRow AddmateriasRow(string desc_materia, int id_plan) {
...
namespace UI.Escritorio.tp2_netDataSet1TableAdapters {
    ...
    public partial class materiasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[materias] WHERE (([id_materia] = @Original_id_materia) AND ([d" +
                "esc_materia] = @Original_desc_materia) AND ([id_plan] = @Original_id_plan))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[materias] SET [desc_materia] = @desc_materia, [id_plan] = @id_plan WHERE (([id_materia] = @Original_id_materia) AND ([desc_materia] = @Original_desc_materia) AND ([id_plan] = @Original_id_plan));
SELECT id_materia, desc_materia, id_plan FROM materias WHERE (id_materia = @id_materia)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_materia, desc_materia, id_plan FROM dbo.materias";
        ...
        public virtual int Delete(int Original_id_materia, string Original_desc_materia, int Original_id_plan) {
        ...
        public virtual int Update(string desc_materia, int id_plan, int Original_id_materia, string Original_desc_materia, int Original_id_plan, int id_materia) {
            ...
            if ((Original_desc_materia == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Original_desc_materia));
            }
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_id_plan));
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(id_materia));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string desc_materia, int id_plan, int Original_id_materia, string Original_desc_materia, int Original_id_plan) {
            return this.Update(desc_materia, id_plan, Original_id_materia, Original_desc_materia, Original_id_plan, Original_id_materia);
        }
    }
