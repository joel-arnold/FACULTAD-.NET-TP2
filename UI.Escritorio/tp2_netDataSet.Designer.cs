...
namespace UI.Escritorio.tp2_netDataSetTableAdapters {
    ...
    public partial class personasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[personas] SET [nombre] = @nombre, [apellido] = @apellido WHERE (([id_persona] = @Original_id_persona) AND ([nombre] = @Original_nombre) AND ([apellido] = @Original_apellido));
SELECT id_persona, nombre, apellido FROM personas WHERE (id_persona = @id_persona)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_persona, nombre, apellido FROM dbo.personas";
        ...
        public virtual int Delete(int Original_id_persona, string Original_nombre, string Original_apellido) {
        ...
        public virtual int Update(string nombre, string apellido, int Original_id_persona, string Original_nombre, string Original_apellido, int id_persona) {
            if ((nombre == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string apellido, int Original_id_persona, string Original_nombre, string Original_apellido) {
            return this.Update(nombre, apellido, Original_id_persona, Original_nombre, Original_apellido, Original_id_persona);
        }
    }
